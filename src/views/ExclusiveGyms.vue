<template>
  <v-container>
    ...
    <v-row no-gutters>
      <v-text-field hint="Press ENTER to Search" @change="getGyms()" v-model="search" outlined rounded label="Search Exclusive Gyms..."></v-text-field>
    ...
    <v-bottom-sheet scrollable persistent inset v-model="addNew">
      <AddNewGym @close="addNew = false; getGyms();" type="EXC"></AddNewGym>
    </v-bottom-sheet>
  </v-container>
</template>
